//////////////////////////////////////////////////////////////////////////////////////          
//
// I don't see how vertex array helps here. There might be other things that could be
// included in VAO that I don't know about.
//
...
#define HEMISPHERE 0 // vertex array index for hemisphere
...
static unsigned int vao[1]; // vertex array ids
...
void drawScene(void)
{
   ...
   glRotatef(Zangle, 0.0, 0.0, 1.0);
   glRotatef(Yangle, 0.0, 1.0, 0.0);
   glRotatef(180 + Xangle, 1.0, 0.0, 0.0);
